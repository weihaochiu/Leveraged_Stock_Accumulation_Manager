...
SHEETS = [
    ...
    ("股價紀錄", "price_history"), ("股價更新批次", "price_update_runs"),
    ("股價更新明細", "price_update_details"), ("報價來源狀態", "price_provider_health"),
    ("券商帳戶", "broker_accounts"),
...
RAW_HEADER_ZH = {
    ...
    "price_date": "價格日期", "source": "來源", "exchange": "市場", "open_price": "開盤價", "high_price": "最高價", "low_price": "最低價",
    "volume_shares": "成交股數", "turnover_twd": "成交金額（元）", "transaction_count": "成交筆數", "price_change": "漲跌價差",
    "quote_type": "報價類型", "fetched_at": "資料取得時間", "is_manual_override": "是否手動覆寫", "warning_message": "警告訊息",
    "trigger_type": "觸發方式", "started_at": "開始時間", "completed_at": "完成時間", "planned_count": "預計檔數",
    "success_count": "官方成功數", "fallback_success_count": "備援成功數", "failed_count": "失敗數", "skipped_count": "略過數",
    "retry_count": "重試次數", "trade_date": "交易日期", "message": "訊息", "last_success_at": "最後成功時間",
    "last_failure_at": "最後失敗時間", "consecutive_failures": "連續失敗次數", "last_error": "最後錯誤",
    "updated_at": "最後修改時間", "created_at": "建立時間", "note": "備註", "active": "啟用",
