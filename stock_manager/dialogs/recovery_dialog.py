...
class RecoveryDialog(QDialog):
    def __init__(self, repository: PortfolioRepository, initial_lot_id: str | None = None, parent=None):
        ...
        button = QPushButton("重新計算"); button.clicked.connect(self.calculate); root.addWidget(button)
        ...
        note.setStyleSheet("color:#6b7280"); root.addWidget(note)
        ...
        try:
            ...
            for r, option in enumerate(options):
                ...
                for c, value in enumerate(values):
                    ...
                    if option.recommended: item.setBackground(QColor("#DCFCE7"))
